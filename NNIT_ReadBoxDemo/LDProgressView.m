...
- (void)drawProgressBackground:(CGContextRef)context inRect:(CGRect)rect {
    ...
    CGContextSetFillColorWithColor(context, [UIColor whiteColor].CGColor);//修改背景的颜色
    [roundedRect fill];
...
- (void)drawProgress:(CGContextRef)context withFrame:(CGRect)frame {
    ...
    CGContextSetStrokeColorWithColor(context, [[self.color darkerColor] darkerColor].CGColor);//修改进度颜色以及阴影
    [roundedRect stroke];
